...
import OffersSortItem from "../offers-sort-item/offers-sort-item.jsx";
...
const OffersSortList = (props) => {
  ...
  const sortingCardsList = SORTING_METHODS.map((method, index) =>
    <OffersSortItem key={index} sortingMethod={index} selectedSortingMethod={selectedSortingMethod} setSortingMethod={changeSortingMethod} />
  );
...
export default connect(mapStateToProps, mapDispatchToProps)(OffersSortList);
