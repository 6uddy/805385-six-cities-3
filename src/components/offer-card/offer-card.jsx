...
import {ratingStyleConverter} from '../../utils/utils.js';
...
const OfferCardComponent = ({renderMode, offer, onOfferMouseInteract, onCardHeadingClick}) => (
  <article
    ...
    <div className="place-card__info">
      ...
      <div className="place-card__rating rating">
        <div className="place-card__stars rating__stars">
          <span style={ratingStyleConverter(offer.rating)}></span>
          <span className="visually-hidden">Rating</span>
        </div>
      </div>
      <h2 className="place-card__name"
        onClick={() => onCardHeadingClick(offer)}
      >
        <a href="#">{offer.name}</a>
      </h2>
...
OfferCardComponent.propTypes = {
  ...
  onCardHeadingClick: PropTypes.func,
