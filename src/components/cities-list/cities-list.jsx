...
import {MemorizedCitiesItem} from "../cities-item/cities-item.jsx";
...
const CitiesList = (props) => {
  ...
  const cityNav = cityNames.map((cityName, index) =>
    <MemorizedCitiesItem key={index} city={cityName} setSelectedCity={setSelectedCity} cityId={index} selectedCityId={selectedCityId} />
  );
