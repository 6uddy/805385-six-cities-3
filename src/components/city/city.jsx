...
import OffersSortList from "../offers-sort-list/offers-sort-list.jsx";
...
const City = (props) => {
  ...
  const cardsElement = sortedCards.map((card) =>
    <MemorizedOfferCard key={card.id} card={card} setSelectedCard = {setSelectedCard} isDetail={false} />
  );
