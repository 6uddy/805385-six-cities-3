...
import {MemorizedOfferCard} from "../offer-card/offer-card.jsx";
import Reviews from "../reviews-list/reviews.jsx";
...
class OfferCardDetails extends PureComponent {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    const cardsElement = similarOffers.map((offer) =>
      <MemorizedOfferCard key={offer.id} card={offer} setSelectedCard={() => {}} isDetail={true} />
    );
...
export default connect(mapStateToProps, mapDispatchToProps)(OfferCardDetails);
